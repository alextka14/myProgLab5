...
/**
 * Класс Launcher предоставляет методы для интерактивного режима и выполнения скриптов.
 */
public class Launcher {
    ...
    /**
     * Конструктор Launcher.
     * @param console консоль
     * @param commandManager менеджер команд
     */
    public Launcher(Console console, CommandManager commandManager) {
